...
const CATEGORIES = [
  {
    name: '① 入札〜契約関係書類',
    items: [
      { text: '入札公告・入札説明書の保管', description: '発注機関が公表した入札公告と、入札の手続き・条件を説明した入札説明書。落札後も参照するため保管しておく書類です。' },
      { text: '設計図面・仕様書の保管', description: '工事の内容・仕様を示す設計図面と仕様書。施工内容の根拠になる基本資料です。' },
      { text: '見積参考資料の保管', description: '見積作成時に使った参考資料（数量調書・単価資料など）。金額の根拠を後から確認できるよう保管します。' },
      { text: '契約書（原本・写し）の受領・保管', description: '発注機関と交わす工事請負契約書。原本は発注機関・受注者双方で保管し、写しも社内で保管します。' },
      { text: '工事費内訳書の提出', description: '契約金額の内訳（材料費・労務費・諸経費など）を示す書類。契約書の付属資料として提出します。' },
